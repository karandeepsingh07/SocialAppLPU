...
public class MainActivityFaculty extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uid = user.getUid();
        email = user.getEmail();
        reference =  FirebaseDatabase.getInstance().getReference().child("Faculty").child("Detail").child(uid);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                FacultyPC organisationPC=dataSnapshot.getValue(FacultyPC.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId())
        {
            case R.id.ViewProfile:
                startActivity(new Intent(MainActivityFaculty.this,FacultyDetailActivity.class));
                break;
            case R.id.Home:
                getSupportFragmentManager().beginTransaction().replace(R.id.Fragment_container,new HomeFragment()).commit();
                break;
            case R.id.Uploadasssign:
                ...
                Fragment fragment2=new UploadPostFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.announcement:
                startActivity(new Intent(MainActivityFaculty.this,AnnouncemntActivity.class));
                break;
            case R.id.search:
                startActivity(new Intent(MainActivityFaculty.this,SearchActivity.class));
                break;
        }
